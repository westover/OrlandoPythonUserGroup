...
plt.plot(y1, label="Filtered without IC", linewidth=4)
plt.xlabel('t')
plt.ylabel('y(t)')
...
plt.subplot(2,1,1)
plt.plot(butterworth_freq, np.abs(butterworth_response), marker='.', label='abs')
plt.xlabel('f/f0')
plt.ylabel('Abs')
...
plt.plot(y, label="Filtered without IC", linewidth=4)
